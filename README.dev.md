...
The `v0.3.0` release finalizes the first ToolX CLI product chain. `v0.2.0`
...
- `docs/releases/v0.3.0.md` and [docs/productization-retro.md](docs/productization-retro.md)
