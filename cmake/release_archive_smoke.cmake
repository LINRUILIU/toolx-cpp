...
if(DEFINED VERIFY_CMAKE_CXX_COMPILER AND NOT VERIFY_CMAKE_CXX_COMPILER STREQUAL "")
    list(APPEND configure_command "-DCMAKE_CXX_COMPILER=${VERIFY_CMAKE_CXX_COMPILER}")
endif()
if(DEFINED VERIFY_CMAKE_BUILD_TYPE AND NOT VERIFY_CMAKE_BUILD_TYPE STREQUAL "")
    list(APPEND configure_command "-DCMAKE_BUILD_TYPE=${VERIFY_CMAKE_BUILD_TYPE}")
endif()
