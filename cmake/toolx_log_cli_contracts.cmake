...
toolx_assert_json_envelope(MISSING_INPUT "${MISSING_INPUT_OUT}" "toolx.log.result" false 2)
...
toolx_assert_json_envelope(MISSING_FILE "${MISSING_FILE_OUT}" "toolx.log.result" false 3)
...
toolx_assert_json_envelope(MISSING_MANIFEST "${MISSING_MANIFEST_OUT}" "toolx.log.result" false 3)
...
toolx_assert_json_envelope(MALFORMED_MANIFEST "${MALFORMED_MANIFEST_OUT}" "toolx.log.result" false 4)
...
toolx_assert_json_envelope(UNKNOWN_MANIFEST "${UNKNOWN_MANIFEST_OUT}" "toolx.log.result" false 4)
...
toolx_assert_json_envelope(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "toolx.log.result" true 0)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "summarize" data command)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "" data manifest)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data files)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "1" data file_count)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "logsys-text" data format)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data filters)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "5" data lines_read)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data blank_lines)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data parsed)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "4" data matched)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "1" data parse_failures)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data time_missing)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data by_level)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "1" data by_level warning)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "1" data by_level error)
toolx_assert_json_value(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" "1" data by_level fatal)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data first_time)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data last_time)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data samples)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data capabilities)
toolx_assert_json_path(TEXT_SUMMARY "${TEXT_SUMMARY_OUT}" data warnings)
...
toolx_assert_json_envelope(JSONL_SUMMARY "${JSONL_SUMMARY_OUT}" "toolx.log.result" true 0)
toolx_assert_json_value(JSONL_SUMMARY "${JSONL_SUMMARY_OUT}" "jsonl" data format)
...
toolx_assert_json_envelope(MANIFEST "${MANIFEST_OUT}" "toolx.log.result" true 0)
toolx_assert_json_value(MANIFEST "${MANIFEST_OUT}" "${manifest_json}" data manifest)
toolx_assert_json_value(MANIFEST "${MANIFEST_OUT}" "2" data matched)
...
toolx_assert_json_envelope(MANIFEST_OVERRIDE "${MANIFEST_OVERRIDE_OUT}" "toolx.log.result" true 0)
toolx_assert_json_value(MANIFEST_OVERRIDE "${MANIFEST_OVERRIDE_OUT}" "3" data matched)
...
toolx_assert_json_envelope(LEVEL_CONFLICT "${LEVEL_CONFLICT_OUT}" "toolx.log.result" false 2)
...
toolx_assert_json_envelope(FAIL_ON_LEVEL "${FAIL_ON_LEVEL_OUT}" "toolx.log.result" false 4)
...
toolx_assert_json_envelope(MAX_PARSE_ERRORS "${MAX_PARSE_ERRORS_OUT}" "toolx.log.result" false 4)
