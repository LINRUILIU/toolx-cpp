...
#define CURSOR_INVISIBLE_					3	//光标不显示
...
void cct_showint(const int X, const int Y, const int num, const int bg_color = COLOR_BLACK, const int fg_color = COLOR_WHITE, const int rpt = 1, const int wid = 0);
...
int  cct_flush_mouse_events     (void);  // 清除输入缓冲区中的鼠标事件
